        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a href="./ConfirmBooking.php" id="back-firm" class="btn btn-primary">Back</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div id="loader-add-customer" style="display:none;" class="overlay">
              <i class="fa fa-refresh fa-spin"></i>
                ...
                <a href="./ConfirmBooking.php"><input type="button" class="btn btn-primary btn-lg float-right" id="add-customer" value="Close"> </a>
              </form>
              </div>
               <!-- /.card-body -->
              </div>
