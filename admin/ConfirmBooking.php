              ...
              <div class="card-body p-0">
                <table class="table table-striped">
                  ...
                  <?php  while ($row = mysqli_fetch_assoc($result)) { ?>
                      ...
                      <td>
                        <a href="viewConfirmBooking.php?id=<?php echo $row["b_id"];?>"><i class="fa fa-eye"></i></a>&nbsp; &nbsp; &nbsp;
                        <!-- <a href="editBooking.php?id=<?php echo $row["b_id"];?>"><i class="fa fa-edit"></i></a>&nbsp; &nbsp; &nbsp; -->
                        <a href="./php/deletetrainer.php?id=<?php echo $row["b_id"]?>"   id="delete-icon"><i class="fa fa-trash" aria-hidden="true"></i></a>  
                    </td>   
                    </tr>
                    <?php }?>
                  </tbody>
